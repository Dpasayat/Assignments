...
public class DeadLockExample {
	public static void main(String[] args) 
	{
	 	 ...
	 	 Thread thread1 = new Thread("First Thread") 
	 	 {
	 		 public void run() 
	 		 {
	 		 	synchronized (firstResource) 
	 		 	{
	 				...
	 				try {
	 					Thread.sleep(100); // this ensures that other thread is executed and deadlock is more probable
	 				}
	 				catch (Exception e) 
	 				{
	 				}
	 	 ...
	 	 // Following code demonstrates thread 2 attempt to lock secondResource then firstResource.
	 	 // If you change the order of resources, no deadlock will occur.
